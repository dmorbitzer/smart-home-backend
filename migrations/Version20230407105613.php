 ...
 */
final class Version20230407105613 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cat (id INT AUTO_INCREMENT NOT NULL, gender_id INT NOT NULL, name VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, weight DOUBLE PRECISION NOT NULL, race VARCHAR(255) NOT NULL, INDEX IDX_9E5E43A8708A0E0 (gender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
